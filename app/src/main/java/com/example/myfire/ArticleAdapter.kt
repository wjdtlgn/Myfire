...
import com.example.myfire.databinding.ItemArticleBinding
...
class ArticleAdapter(val onItemClicked: (ArticleMddel) -> Unit): ListAdapter<ArticleMddel, ArticleAdapter.ViewHolder>(diffUtil) {
    inner class ViewHolder(private val binding: ItemArticleBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(articleModel: ArticleMddel) {
            ...
            binding.sellerTextView.text = articleModel.sellerName
            binding.sellStatusTextView.text = articleModel.content
